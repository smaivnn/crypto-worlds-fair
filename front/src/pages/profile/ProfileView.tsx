...
import type { FormValues } from './section/form/form.schema';
...
const ProfileView = ({
    ...
    return (
        <section className="px-4 md:px-6">
            <form
                className="max-w-2xl mx-auto my-12 md:my-20 p-6 md:p-8 border rounded-lg shadow-sm"
                    ...
                    <FieldGroup>
                        ...
                        <Field>
                            ...
                            <button
                                ...
                                aria-invalid={hasBirthDateError ? 'true' : 'false'}
                            ...
                            {hasBirthDateError && <FieldError>Birth Date is required.</FieldError>}
                        </Field>
